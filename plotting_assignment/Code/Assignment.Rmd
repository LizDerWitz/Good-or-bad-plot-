...
# Description
Subject ID is wrong, because their age is actually being displayed. Putting a dotplot on the violin plot makes the interpretation harder, also because of the dotsize and the quantity of information. 
By using a violing plot and a box plot there is overlapping on the data.