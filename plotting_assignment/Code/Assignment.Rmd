...
speed_dating_data <- data.frame(   
  ...
  gender = sample(c("Male", "Female"), n, replace = TRUE), #I am considering only straight people, sorry gays </3
  ...
  attraction_feeling = sample(0:1, n, replace = TRUE, prob = c(0.5, 0.5)),  # Randomly assign whether they felt attracted (50% chance)
  partner_id = sample(1:n, n, replace = TRUE)  # Randomly assign a partner_id (random partner for each participant)
)
